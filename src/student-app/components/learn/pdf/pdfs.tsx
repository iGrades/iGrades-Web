    ...
    try {
      ...
      if (topicIds.length > 0) {
        ...
        if (pdfsError) {
          ...
          setPdfs(pdfsData || []);
          setTopicList(true);
          console.log("PDFs found:", pdfsData);
