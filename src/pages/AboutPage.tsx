...
const milestones = [
  { year: "2021", title: "iGrades Founded", desc: "Started as a WhatsApp study group in Ibadan. First 50 students enrolled in beta." },
              ...
              <HStack justify="center" gap={4} flexWrap="wrap">
                ...
                <RouterLink to="/login" style={{ textDecoration: "none" }}>
                  <Box 
                    ...
                    _hover={{ transform: "translateY(-2px)", boxShadow: "0 12px 40px rgba(241,135,41,0.5)", textDecoration: "none" }}
                    transition="all .2s"
                  >
