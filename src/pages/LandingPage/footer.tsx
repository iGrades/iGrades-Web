...
const Footer = () => {
  ...
  const socials = [
    { icon: <FaXTwitter />, href: "https://x.com/goodindomitable?s=21", label: "X" },
    { icon: <FaInstagram />, href: "https://www.instagram.com/igradesapp?igsh=MWkzOG9lc3lxMmJuZA%3D%3D&utm_source=qr", label: "Instagram" },
    { icon: <FaFacebookF />, href: "https://www.facebook.com/share/1HscvuX9Vh/?mibextid=wwXIfr", label: "Facebook" },
